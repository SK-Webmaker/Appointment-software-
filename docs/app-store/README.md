...
| 6 — Build, in shippable slices | [`06-phase-6-build-log.md`](06-phase-6-build-log.md) | **In progress — slices 1–6 done (harness, shard, move tool, platform, connectors, the app)** |
